...
public class ItemSetup extends TFCItems {
	...
	public static void setup()
	{
		...
		bismuthIngot2x = ((ItemIngot)new ItemIngot().setUnlocalizedName("Bismuth Double Ingot")).setSize(EnumSize.LARGE).setMetal("Bismuth", 100);
		bismuthBronzeIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Bismuth Bronze Double Ingot")).setSize(EnumSize.LARGE).setMetal("Bismuth Bronze", 100);
		blackBronzeIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Black Bronze Double Ingot")).setSize(EnumSize.LARGE).setMetal("Black Bronze", 100);
		blackSteelIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Black Steel Double Ingot")).setSize(EnumSize.LARGE).setMetal("Black Steel", 100);
		blueSteelIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Blue Steel Double Ingot")).setSize(EnumSize.LARGE).setMetal("Blue Steel", 100);
		brassIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Brass Double Ingot")).setSize(EnumSize.LARGE).setMetal("Brass", 100);
		bronzeIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Bronze Double Ingot")).setSize(EnumSize.LARGE).setMetal("Bronze", 100);
		copperIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Copper Double Ingot")).setSize(EnumSize.LARGE).setMetal("Copper", 100);
		goldIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Gold Double Ingot")).setSize(EnumSize.LARGE).setMetal("Gold", 100);
		wroughtIronIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Wrought Iron Double Ingot")).setSize(EnumSize.LARGE).setMetal("Wrought Iron", 100);
		leadIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Lead Double Ingot")).setSize(EnumSize.LARGE).setMetal("Lead", 100);
		nickelIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Nickel Double Ingot")).setSize(EnumSize.LARGE).setMetal("Nickel", 100);
		pigIronIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Pig Iron Double Ingot")).setSize(EnumSize.LARGE).setMetal("Pig Iron", 100);
		platinumIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Platinum Double Ingot")).setSize(EnumSize.LARGE).setMetal("Platinum", 100);
		redSteelIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Red Steel Double Ingot")).setSize(EnumSize.LARGE).setMetal("Red Steel", 100);
		roseGoldIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Rose Gold Double Ingot")).setSize(EnumSize.LARGE).setMetal("Rose Gold", 100);
		silverIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Silver Double Ingot")).setSize(EnumSize.LARGE).setMetal("Silver", 100);
		steelIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Steel Double Ingot")).setSize(EnumSize.LARGE).setMetal("Steel", 100);
		sterlingSilverIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Sterling Silver Double Ingot")).setSize(EnumSize.LARGE).setMetal("Sterling Silver", 100);
		tinIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Tin Double Ingot")).setSize(EnumSize.LARGE).setMetal("Tin", 100);
		zincIngot2x  = ((ItemIngot)new ItemIngot().setUnlocalizedName("Zinc Double Ingot")).setSize(EnumSize.LARGE).setMetal("Zinc", 100);
		electrumIngot2x = ((ItemIngot)new ItemIngot().setUnlocalizedName("Electrum Double Ingot")).setSize(EnumSize.LARGE).setMetal("Electrum", 100);
		cupronickelIngot2x = ((ItemIngot)new ItemIngot().setUnlocalizedName("Cupronickel Double Ingot")).setSize(EnumSize.LARGE).setMetal("Cupronickel", 100);
		osmiumIngot2x = ((ItemIngot)new ItemIngot().setUnlocalizedName("Osmium Double Ingot")).setSize(EnumSize.LARGE).setMetal("Osmium", 100);
		aluminumIngot2x = ((ItemIngot)new ItemIngot().setUnlocalizedName("Aluminum Double Ingot")).setSize(EnumSize.LARGE).setMetal("Aluminum", 100);
		tungstenIngot2x = ((ItemIngot)new ItemIngot().setUnlocalizedName("Tungsten Double Ingot")).setSize(EnumSize.LARGE).setMetal("Tungsten", 100);
	...
	public static void setupArmor()
	{
		...
		bismuthSheet = 			((ItemMetalSheet) new ItemMetalSheet(0).setUnlocalizedName("Bismuth Sheet")).setMetal("Bismuth", 100);
		bismuthBronzeSheet = 	((ItemMetalSheet) new ItemMetalSheet(1).setUnlocalizedName("Bismuth Bronze Sheet")).setMetal("Bismuth Bronze", 100);
		blackBronzeSheet = 		((ItemMetalSheet) new ItemMetalSheet(2).setUnlocalizedName("Black Bronze Sheet")).setMetal("Black Bronze", 100);
		blackSteelSheet = 		((ItemMetalSheet) new ItemMetalSheet(3).setUnlocalizedName("Black Steel Sheet")).setMetal("Black Steel", 100);
		blueSteelSheet = 		((ItemMetalSheet) new ItemMetalSheet(4).setUnlocalizedName("Blue Steel Sheet")).setMetal("Blue Steel", 100);
		bronzeSheet = 			((ItemMetalSheet) new ItemMetalSheet(6).setUnlocalizedName("Bronze Sheet")).setMetal("Bronze", 100);
		copperSheet = 			((ItemMetalSheet) new ItemMetalSheet(7).setUnlocalizedName("Copper Sheet")).setMetal("Copper", 100);
		wroughtIronSheet = 		((ItemMetalSheet) new ItemMetalSheet(9).setUnlocalizedName("Wrought Iron Sheet")).setMetal("Wrought Iron", 100);
		redSteelSheet = 		((ItemMetalSheet) new ItemMetalSheet(14).setUnlocalizedName("Red Steel Sheet")).setMetal("Red Steel", 100);
		roseGoldSheet = 		((ItemMetalSheet) new ItemMetalSheet(15).setUnlocalizedName("Rose Gold Sheet")).setMetal("Rose Gold", 100);
		steelSheet = 			((ItemMetalSheet) new ItemMetalSheet(17).setUnlocalizedName("Steel Sheet")).setMetal("Steel", 100);
		tinSheet = 				((ItemMetalSheet) new ItemMetalSheet(19).setUnlocalizedName("Tin Sheet")).setMetal("Tin", 100);
		zincSheet = 			((ItemMetalSheet) new ItemMetalSheet(20).setUnlocalizedName("Zinc Sheet")).setMetal("Zinc", 100);
		electrumSheet = 		((ItemMetalSheet) new ItemMetalSheet(21).setUnlocalizedName("Electrum Sheet")).setMetal("Electrum", 100);
		cupronickelSheet = 		((ItemMetalSheet) new ItemMetalSheet(22).setUnlocalizedName("Cupronickel Sheet")).setMetal("Cupronickel", 100);
		osmiumSheet = 			((ItemMetalSheet) new ItemMetalSheet(23).setUnlocalizedName("Osmium Sheet")).setMetal("Osmium", 100);
		aluminumSheet = 		((ItemMetalSheet) new ItemMetalSheet(24).setUnlocalizedName("Aluminum Sheet")).setMetal("Aluminum", 100);
		tungstenSheet = 		((ItemMetalSheet) new ItemMetalSheet(25).setUnlocalizedName("Tungsten Sheet")).setMetal("Tungsten", 100);

		bismuthSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(0).setUnlocalizedName("Bismuth Double Sheet")).setMetal("Bismuth", 200);
		bismuthBronzeSheet2x = 	((ItemMetalSheet2x) new ItemMetalSheet2x(1).setUnlocalizedName("Bismuth Bronze Double Sheet")).setMetal("Bismuth Bronze", 200);
		blackBronzeSheet2x = 	((ItemMetalSheet2x) new ItemMetalSheet2x(2).setUnlocalizedName("Black Bronze Double Sheet")).setMetal("Black Bronze", 200);
		blackSteelSheet2x = 	((ItemMetalSheet2x) new ItemMetalSheet2x(3).setUnlocalizedName("Black Steel Double Sheet")).setMetal("Black Steel", 200);
		blueSteelSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(4).setUnlocalizedName("Blue Steel Double Sheet")).setMetal("Blue Steel", 200);
		bronzeSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(6).setUnlocalizedName("Bronze Double Sheet")).setMetal("Bronze", 200);
		copperSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(7).setUnlocalizedName("Copper Double Sheet")).setMetal("Copper", 200);
		wroughtIronSheet2x = 	((ItemMetalSheet2x) new ItemMetalSheet2x(9).setUnlocalizedName("Wrought Iron Double Sheet")).setMetal("Wrought Iron", 200);
		redSteelSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(14).setUnlocalizedName("Red Steel Double Sheet")).setMetal("Red Steel", 200);
		roseGoldSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(15).setUnlocalizedName("Rose Gold Double Sheet")).setMetal("Rose Gold", 200);
		steelSheet2x = 			((ItemMetalSheet2x) new ItemMetalSheet2x(17).setUnlocalizedName("Steel Double Sheet")).setMetal("Steel", 200);
		tinSheet2x = 			((ItemMetalSheet2x) new ItemMetalSheet2x(19).setUnlocalizedName("Tin Double Sheet")).setMetal("Tin", 200);
		zincSheet2x = 			((ItemMetalSheet2x) new ItemMetalSheet2x(20).setUnlocalizedName("Zinc Double Sheet")).setMetal("Zinc", 200);
		electrumSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(21).setUnlocalizedName("Electrum Double Sheet")).setMetal("Electrum", 200);
		cupronickelSheet2x = 	((ItemMetalSheet2x) new ItemMetalSheet2x(22).setUnlocalizedName("Cupronickel Double Sheet")).setMetal("Cupronickel", 200);
		osmiumSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(23).setUnlocalizedName("Osmium Double Sheet")).setMetal("Osmium", 200);
		aluminumSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(24).setUnlocalizedName("Aluminum Double Sheet")).setMetal("Aluminum", 200);
		tungstenSheet2x = 		((ItemMetalSheet2x) new ItemMetalSheet2x(25).setUnlocalizedName("Tungsten Double Sheet")).setMetal("Tungsten", 200);

		i = 0;
		brassSheet = 			new ItemMetalSheet(5).setMetal("Brass", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		goldSheet = 			new ItemMetalSheet(8).setMetal("Gold", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		leadSheet = 			new ItemMetalSheet(10).setMetal("Lead", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		nickelSheet = 			new ItemMetalSheet(11).setMetal("Nickel", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		pigIronSheet = 			new ItemMetalSheet(12).setMetal("Pig Iron", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		platinumSheet = 		new ItemMetalSheet(13).setMetal("Platinum", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		silverSheet = 			new ItemMetalSheet(16).setMetal("Silver", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");
		sterlingSilverSheet = 	new ItemMetalSheet(18).setMetal("Sterling Silver", 100).setUnlocalizedName(namesNSO[i++]+" Sheet");

		i = 0;
		brassSheet2x = 			new ItemMetalSheet2x(5).setMetal("Brass", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		goldSheet2x = 			new ItemMetalSheet2x(8).setMetal("Gold", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		leadSheet2x = 			new ItemMetalSheet2x(10).setMetal("Lead", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		nickelSheet2x = 		new ItemMetalSheet2x(1).setMetal("Nickel", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		pigIronSheet2x = 		new ItemMetalSheet2x(12).setMetal("Pig Iron", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		platinumSheet2x = 		new ItemMetalSheet2x(13).setMetal("Platinum", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		silverSheet2x = 		new ItemMetalSheet2x(16).setMetal("Silver", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
		sterlingSilverSheet2x = new ItemMetalSheet2x(18).setMetal("Sterling Silver", 200).setUnlocalizedName(namesNSO[i++]+" Double Sheet");
